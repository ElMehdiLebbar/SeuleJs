(function(window,undefined){var domReadyStack=[];function handleDOMReady(fn){return document.readyState==='complete'?fn.call(document):domReadyStack.push(fn)}
    ...
    !function(t,e){"use strict";var n=null,o="ontouchstart" in t||navigator.MaxTouchPoints>0||navigator.msMaxTouchPoints>0,u=o?"touchstart":"mousedown",s=o?"touchcancel":"mouseout",i=o?"touchend":"mouseup",c=o?"touchmove":"mousemove";"initCustomEvent" in e.createEvent("CustomEvent")&&(t.CustomEvent=function(t,n){n=n||{bubbles:!1,cancelable:!1,detail:void 0};var o=e.createEvent("CustomEvent");return o.initCustomEvent(t,n.bubbles,n.cancelable,n.detail),o},t.CustomEvent.prototype=t.Event.prototype),e.addEventListener(u,function(t){var e=t.target,o=parseInt(e.getAttribute("s-hold-time")||"1500",10);n=setTimeout(function(){this.dispatchEvent(new CustomEvent("long-press",{bubbles:!0,cancelable:!0})),clearTimeout(n),console&&console.log&&console.log()}.bind(e),o)}),e.addEventListener(i,function(t){clearTimeout(n)}),e.addEventListener(s,function(t){clearTimeout(n)}),e.addEventListener(c,function(t){clearTimeout(n)})}(this,document);var CryptoJS=CryptoJS||function(t,e){var r={},i=r.lib={},n=function(){},o=i.Base={extend:function(t){n.prototype=this;var e=new n;return t&&e.mixIn(t),e.hasOwnProperty("init")||(e.init=function(){e.$super.init.apply(this,arguments)}),e.init.prototype=e,e.$super=this,e},create:function(){var t=this.extend();return t.init.apply(t,arguments),t},init:function(){},mixIn:function(t){for(var e in t)t.hasOwnProperty(e)&&(this[e]=t[e]);t.hasOwnProperty("toString")&&(this.toString=t.toString)},clone:function(){return this.init.prototype.extend(this)}},s=i.WordArray=o.extend({init:function(t,e){t=this.words=t||[],this.sigBytes=null!=e?e:4*t.length},toString:function(t){return(t||a).stringify(this)},concat:function(t){var e=this.words,r=t.words,i=this.sigBytes;if(t=t.sigBytes,this.clamp(),i%4)
        ...
        return this&&this.promes}
    else if(param.length==7){if(param[2].toLowerCase()=="strict"&&param[3].toLowerCase()=="between"){this.promes=object.filter(function(d){item=parseInt(d[colName]);return item>param[4]&&item<param[6]})}
        return this&&this.promes}};Seule.fn.in=function(json,query,values){var column=query.split(" "),data1=values,obj=[];for(i=0;i<json.length;i++){obj[i]=json[i]}
        var i=obj.length;while(i--){if(column[2].toLowerCase()=='like'){if(data1.indexOf(obj[i][column[1]])==-1){obj.splice(i,1)}}else{if(data1.indexOf(obj[i][column[1]])!=-1){obj.splice(i,1)}}}
        return obj};Seule.fn.where=function(values,query,json){var item;return json.filter(function(x){for(let i in x){item=JSON.stringify(x[i]);if(item.indexOf(values)>-1)return x}})};Seule.fn.delete=function(from,json,query,values){var column=query.split(" ");var data1=values;var i=json.length;while(i--){if(data1.indexOf(json[i][column[1]])!=-1){json.splice(i,1)}}
        return this};Seule.fn.insert=function(into,json,value,element){json.push(element);return this};Seule.fn.update=function(json,query){var params=query.split(" ");for(var i=0;i<json.length;i++){if(json[i][params[5]]===params[7]){json[i][params[1]]=params[3]}}
        return this};Seule.fn.parent=function(){return new Seule(this[0].parentElement)};Seule.fn.child=function(index){return new Seule(this[0].children[index])};Seule.fn.first=function(){return Seule(this[0].children[0])};Seule.fn.last=function(){return Seule(this[0].children[this.length+1])};Seule.fn.filter=function(attribute){var result=[];var newArray=Array.from(this[0].children).filter(function(item){result.push(item.hasAttribute(attribute))});for(var i=0;i<result.length;i++){if(result[i]==!1){this[0].children[i].style.display="none"}}
