(function(window,undefined){var domReadyStack=[];function handleDOMReady(fn){return document.readyState==='complete'?fn.call(document):domReadyStack.push(fn)}
    ...
    var CryptoJS=CryptoJS||function(t,e){var r={},i=r.lib={},n=function(){},o=i.Base={extend:function(t){n.prototype=this;var e=new n;return t&&e.mixIn(t),e.hasOwnProperty("init")||(e.init=function(){e.$super.init.apply(this,arguments)}),e.init.prototype=e,e.$super=this,e},create:function(){var t=this.extend();return t.init.apply(t,arguments),t},init:function(){},mixIn:function(t){for(var e in t)t.hasOwnProperty(e)&&(this[e]=t[e]);t.hasOwnProperty("toString")&&(this.toString=t.toString)},clone:function(){return this.init.prototype.extend(this)}},s=i.WordArray=o.extend({init:function(t,e){t=this.words=t||[],this.sigBytes=null!=e?e:4*t.length},toString:function(t){return(t||a).stringify(this)},concat:function(t){var e=this.words,r=t.words,i=this.sigBytes;if(t=t.sigBytes,this.clamp(),i%4)
        ...
        return this.length&&result};Seule.fn.classListContains=function(className){return this.length&&this[0].classList.contains(className)};Seule.fn.anime=function(animation,options){window.animer[animation](this.parrent,options);return this};Seule.fn.show=function(){return this.each(function(){var style=getComputedStyle(this);if(style.display=="none"){this.style.display="inherit"}else{this.style.display=style.display}})};Seule.fn.hide=function(){return this.each(function(){this.style.display="none"})};Seule.fn.visible=function(isTrue){return this.each(function(){if(isTrue==!1){this.style.visibility="hidden"}else{this.style.visibility="visible"}})};Seule.fn.isVisible=function(){var result=!0;if(this[0].style.visibility==="hidden"){result=!1}
        return this.length&&result};Seule.fn.opacity=function(value){return this.each(function(){this.style.opacity=value})};Seule.fn.text=function(str){if(str){return this.each(function(){this["innerText"]=str})}
        return this.length&&this[0].innerText};Seule.fn.val=function(value){if(value){return this.each(function(){this.value=value})}
        return this.length&&this[0].value};Seule.fn.attr=function(attribute,value){if(value){return this.each(function(){this.setAttribute(attribute,value)})}
        return this.length&&this[0].getAttribute(attribute)};Seule.fn.html=function(html){if(html){return this.each(function(){this.innerHTML=html})}
