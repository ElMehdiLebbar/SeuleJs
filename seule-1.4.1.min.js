(function(window,undefined){var domReadyStack=[];function handleDOMReady(fn){return document.readyState==='complete'?fn.call(document):domReadyStack.push(fn)}
    ...
    var CryptoJS=CryptoJS||function(t,e){var r={},i=r.lib={},n=function(){},o=i.Base={extend:function(t){n.prototype=this;var e=new n;return t&&e.mixIn(t),e.hasOwnProperty("init")||(e.init=function(){e.$super.init.apply(this,arguments)}),e.init.prototype=e,e.$super=this,e},create:function(){var t=this.extend();return t.init.apply(t,arguments),t},init:function(){},mixIn:function(t){for(var e in t)t.hasOwnProperty(e)&&(this[e]=t[e]);t.hasOwnProperty("toString")&&(this.toString=t.toString)},clone:function(){return this.init.prototype.extend(this)}},s=i.WordArray=o.extend({init:function(t,e){t=this.words=t||[],this.sigBytes=null!=e?e:4*t.length},toString:function(t){return(t||a).stringify(this)},concat:function(t){var e=this.words,r=t.words,i=this.sigBytes;if(t=t.sigBytes,this.clamp(),i%4)
        ...
        return this};Seule.fn.objectToUrlQuery=function(obj){var s=Object.keys(obj).map(function(key){return key+"="+obj[key]}).join("&");return this.length&&("'"+s+"'").slice(1).slice(0,-1)};Seule.fn.storage=function(nom,objet){return this.length&&new Promise(function(resolve,reject){window.localStorage.setItem(nom,JSON.stringify(objet));resolve(nom+" was successfully created!");reject("Can not create "+nom)})};Seule.fn.getStorage=function(nom){return this.length&&JSON.parse(window.localStorage.getItem(nom))};Seule.fn.storageDelete=function(nom){return this.length&&new Promise(function(resolve,reject){window.localStorage.removeItem(nom);resolve(nom+" was deleted!");reject("Unable to delete"+nom)})};Seule.fn.storageClear=function(){return this.length&&new Promise(function(resolve,reject){window.localStorage.clear();resolve("Local Storage is clear");reject("Unable to reset the Local Stocakge")})};Seule.fn.select=function(from,object,query,val,orderBy){var param=query.split(" "),cols=from.split(" "),colName=param[1],order,result,rows=[],item;if(param.length==3){if(param[2]==">"){this.promes=object.filter(function(d){item=parseInt(d[colName]);return item>parseInt(val)})}
        ...
        return c})};Seule.fn.parent=function(){return new Seule(this[0].parentElement)};Seule.fn.child=function(index){return new Seule(this[0].children[index])};Seule.fn.first=function(){return Seule(this[0].children[0])};Seule.fn.last=function(){return Seule(this[0].children[this.length+1])};Seule.fn.filter=function(attribute){var result=[];var newArray=Array.from(this[0].children).filter(function(item){result.push(item.hasAttribute(attribute))});for(var i=0;i<result.length;i++){if(result[i]==!1){this[0].children[i].style.display="none"}}
