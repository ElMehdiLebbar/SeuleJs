(function(window,undefined){var domReadyStack=[];function handleDOMReady(fn){return document.readyState==='complete'?fn.call(document):domReadyStack.push(fn)}
    document.addEventListener('DOMContentLoaded',function onDOMReady(){document.removeEventListener('DOMContentLoaded',onDOMReady);while(domReadyStack.length){domReadyStack.shift().call(document)}});function Seule(selector,child){if(!(this instanceof Seule)){if(child==null){return new Seule(selector)}else{return new Seule(selector,child)}}
        if(typeof selector==='function'){return handleDOMReady(selector)}
        if(selector==null){return Seule('html')}
        this.length=0;this.nodes=[];this.parrent=selector;this.promes=[];if(child!=null){selector=child}
        if(selector instanceof HTMLElement||selector instanceof NodeList){this.nodes=selector.length>1?[].slice.call(selector):[selector]}else if(typeof selector==='string'){if(selector[0]==='<'&&selector[selector.length-1]===">"){this.nodes=[createNode(selector)]}else{if(child!=null){var parent=document.querySelector(this.parrent);this.nodes=[].slice.call(parent.shadowRoot.querySelectorAll(selector))}else{this.nodes=[].slice.call(document.querySelectorAll(selector))}}}
        if(this.nodes.length){this.length=this.nodes.length;for(var i=0;i<this.nodes.length;i++){this[i]=this.nodes[i]}}}
    function createNode(html){var div=document.createElement('div');div.innerHTML=html;return div.firstChild}
    function hTmlplace(pos,position){switch(!0){case position==='top':pos='afterbegin';break;case position==='before':pos='beforebegin';break;case position==null&&pos==="afterend":pos='afterend';break;default:pos="beforeend"}
        return pos}
    !function(t,e){"use strict";var n=null,o="ontouchstart" in t||navigator.MaxTouchPoints>0||navigator.msMaxTouchPoints>0,u=o?"touchstart":"mousedown",s=o?"touchcancel":"mouseout",i=o?"touchend":"mouseup",c=o?"touchmove":"mousemove";"initCustomEvent" in e.createEvent("CustomEvent")&&(t.CustomEvent=function(t,n){n=n||{bubbles:!1,cancelable:!1,detail:void 0};var o=e.createEvent("CustomEvent");return o.initCustomEvent(t,n.bubbles,n.cancelable,n.detail),o},t.CustomEvent.prototype=t.Event.prototype),e.addEventListener(u,function(t){var e=t.target,o=parseInt(e.getAttribute("s-hold-time")||"1500",10);n=setTimeout(function(){this.dispatchEvent(new CustomEvent("long-press",{bubbles:!0,cancelable:!0})),clearTimeout(n),console&&console.log&&console.log()}.bind(e),o)}),e.addEventListener(i,function(t){clearTimeout(n)}),e.addEventListener(s,function(t){clearTimeout(n)}),e.addEventListener(c,function(t){clearTimeout(n)})}(this,document);function sortByProperty(property){return function(a,b){if(a[property]>b[property])
        return 1;else if(a[property]<b[property])
        return-1;return 0}}
    var CryptoJS=CryptoJS||function(t,e){var r={},i=r.lib={},n=function(){},o=i.Base={extend:function(t){n.prototype=this;var e=new n;return t&&e.mixIn(t),e.hasOwnProperty("init")||(e.init=function(){e.$super.init.apply(this,arguments)}),e.init.prototype=e,e.$super=this,e},create:function(){var t=this.extend();return t.init.apply(t,arguments),t},init:function(){},mixIn:function(t){for(var e in t)t.hasOwnProperty(e)&&(this[e]=t[e]);t.hasOwnProperty("toString")&&(this.toString=t.toString)},clone:function(){return this.init.prototype.extend(this)}},s=i.WordArray=o.extend({init:function(t,e){t=this.words=t||[],this.sigBytes=null!=e?e:4*t.length},toString:function(t){return(t||a).stringify(this)},concat:function(t){var e=this.words,r=t.words,i=this.sigBytes;if(t=t.sigBytes,this.clamp(),i%4)
            for(var n=0;n<t;n++)e[i+n>>>2]|=(r[n>>>2]>>>24-n%4*8&255)<<24-(i+n)%4*8;else if(65535<r.length)
            for(n=0;n<t;n+=4)e[i+n>>>2]=r[n>>>2];else e.push.apply(e,r);return this.sigBytes+=t,this},clamp:function(){var e=this.words,r=this.sigBytes;e[r>>>2]&=4294967295<<32-r%4*8,e.length=t.ceil(r/4)},clone:function(){var t=o.clone.call(this);return t.words=this.words.slice(0),t},random:function(e){for(var r=[],i=0;i<e;i+=4)r.push(4294967296*t.random()|0);return new s.init(r,e)}}),c=r.enc={},a=c.Hex={stringify:function(t){var e=t.words;t=t.sigBytes;for(var r=[],i=0;i<t;i++){var n=e[i>>>2]>>>24-i%4*8&255;r.push((n>>>4).toString(16)),r.push((15&n).toString(16))}
            return r.join("")},parse:function(t){for(var e=t.length,r=[],i=0;i<e;i+=2)r[i>>>3]|=parseInt(t.substr(i,2),16)<<24-i%8*4;return new s.init(r,e/2)}},f=c.Latin1={stringify:function(t){var e=t.words;t=t.sigBytes;for(var r=[],i=0;i<t;i++)r.push(String.fromCharCode(e[i>>>2]>>>24-i%4*8&255));return r.join("")},parse:function(t){for(var e=t.length,r=[],i=0;i<e;i++)r[i>>>2]|=(255&t.charCodeAt(i))<<24-i%4*8;return new s.init(r,e)}},h=c.Utf8={stringify:function(t){try{return decodeURIComponent(escape(f.stringify(t)))}catch(t){throw Error("Malformed UTF-8 data")}},parse:function(t){return f.parse(unescape(encodeURIComponent(t)))}},u=i.BufferedBlockAlgorithm=o.extend({reset:function(){this._data=new s.init,this._nDataBytes=0},_append:function(t){"string"==typeof t&&(t=h.parse(t)),this._data.concat(t),this._nDataBytes+=t.sigBytes},_process:function(e){var r=this._data,i=r.words,n=r.sigBytes,o=this.blockSize,c=n/(4*o);if(e=(c=e?t.ceil(c):t.max((0|c)-this._minBufferSize,0))*o,n=t.min(4*e,n),e){for(var a=0;a<e;a+=o)this._doProcessBlock(i,a);a=i.splice(0,e),r.sigBytes-=n}
            return new s.init(a,n)},clone:function(){var t=o.clone.call(this);return t._data=this._data.clone(),t},_minBufferSize:0});i.Hasher=u.extend({cfg:o.extend(),init:function(t){this.cfg=this.cfg.extend(t),this.reset()},reset:function(){u.reset.call(this),this._doReset()},update:function(t){return this._append(t),this._process(),this},finalize:function(t){return t&&this._append(t),this._doFinalize()},blockSize:16,_createHelper:function(t){return function(e,r){return new t.init(r).finalize(e)}},_createHmacHelper:function(t){return function(e,r){return new p.HMAC.init(t,r).finalize(e)}}});var p=r.algo={};return r}(Math);Seule.fn=Seule.prototype;Seule.fn.each=function(callback){for(var i=0;i<this.length;i++){callback.call(this[i],this,i)}
        return this};Seule.fn.loop=function(obj){var mir;if(obj.obj==null){mir=this.mSelect(this.parrent)}else{mir=obj.obj}
        if(obj.times!=null){for(var i=0;i<obj.times;i++){obj.handler()}}else{[].forEach.call(mir,obj.handler)}
        return this};Seule.fn.call=function(module){var lastTree=module.substr(module.length-3);if(lastTree!='.js'){module="seule."+module+".min.js"}
        var imported=document.createElement('script');imported.src=module;if(lastTree==='.js'){setTimeout(function(){document.body.appendChild(imported)},300)}else{document.body.appendChild(imported)}};Seule.fn.require=function(module){switch(!0){case typeof module==='object':if(module.indexOf("htmlSetting")>-1){this.htmlSetting()}
        if(module.indexOf("cryptographic")>-1){this.callCrypto()}
        if(module.indexOf("anime")>-1){this.callAnimation()}
        if(module.indexOf("scroll.smooth")>-1){this.callScrolling();var scroll=new SmoothScroll('a[href*="#"]')}
        if(module.indexOf("hotKey")>-1){this.callHotkey()}
        if(module.indexOf("autoComplete")>-1){this.call('autoComplete')}
        if(module.indexOf("input.pattern")>-1){this.call('input.pattern')}
        if(module.indexOf("scroll.animation")>-1){this.call('scroll')}
        break;default:this.call(module)}
        return this};Seule.fn.objectToStyle=function(obj){return this.objectToUrlQuery(obj).replace(/&/g,";").replace(/=/g,":")};Seule.fn.objectToUrlQuery=function(obj){var s=Object.keys(obj).map(function(key){return key+"="+obj[key]}).join("&");return this.length&&("'"+s+"'").slice(1).slice(0,-1)};Seule.fn.storage=function(name,object){return this.length&&new Promise(function(resolve,reject){window.localStorage.setItem(name,JSON.stringify(object));resolve(name+" was successfully created!");reject("Can not create "+name)})};Seule.fn.getStorage=function(name){return this.length&&JSON.parse(window.localStorage.getItem(name))};Seule.fn.storageDelete=function(name){return this.length&&new Promise(function(resolve,reject){window.localStorage.removeItem(name);resolve(name+" was deleted!");reject("Unable to delete"+name)})};Seule.fn.storageClear=function(){return this.length&&new Promise(function(resolve,reject){window.localStorage.clear();resolve("Local Storage is clear");reject("Unable to reset the Local Stocakge")})};Seule.fn.select=function(from,object,query,val,orderBy){var param=query.split(" "),cols=from.split(" "),colName=param[1],order,result,rows=[],item;if(param.length==3){if(param[2]==">"){this.promes=object.filter(function(d){item=parseInt(d[colName]);return item>parseInt(val)})}
    else if(param[2]=="<"){this.promes=object.filter(function(d){item=parseInt(d[colName]);return item<parseInt(val)})}
    else if(param[2].toLowerCase()=="notLike"||param[2]=="!="){this.promes=object.filter(function(d){item=JSON.stringify(d[colName]);return item.toLowerCase()!==val.toLowerCase()})}
    else if(param[2]=="<="){this.promes=object.filter(function(d){item=parseInt(d[colName]);return item<=parseInt(val)})}
    else if(param[2]==">="){this.promes=object.filter(function(d){item=parseInt(d[colName]);return item>=parseInt(val)})}
    else if(param[2].toLowerCase()==="like"||param[2]=="="){this.promes=object.filter(function(d){item=d[colName].toString().toLowerCase();if(param[2].toLowerCase()==="like"){if(val.includes("%")){var newStr=val.toString().toLowerCase().replace(/%/g,"");if(item.indexOf(newStr)>-1)return d}}
        return item===val.toString().toLowerCase()})}
        if(orderBy!=null){order=orderBy.split(" ");result=this.promes.sort(sortByProperty(order[2]))}else{result=this.promes}
        if(cols[0]!='*'){result=result.map(function(a){return JSON.parse('{"'+cols[0]+'":"'+a[cols[0]]+'"}')})}
        return result}
    else if(param.length>=6){if(param[2].toLowerCase()=="between"){this.promes=object.filter(function(d){item=parseInt(d[colName]);return item>=param[3]&&item<=param[5]})}
        if(param[2].toLowerCase()=="strict"&&param[3].toLowerCase()=="between"){this.promes=object.filter(function(d){item=parseInt(d[colName]);return item>param[4]&&item<param[6]})}
        if(param.length===9){result=this.promes.sort(sortByProperty(param[8]))}else if(param.length===10){result=this.promes.sort(sortByProperty(param[9]))}else{result=this.promes}
        if(cols[0]!='*'){result=result.map(function(a){return JSON.parse('{"'+cols[0]+'":"'+a[cols[0]]+'"}')})}
        return result}
        return'the server detected a syntax error in your request. check your request and all parameters'};Seule.fn.not=function(property,from,object,query,val,orderBy){from='* '+from;var objitem=this.select(from,object,query,val,orderBy);return objitem.map(function(o){var c=Object.assign({},o);for(var j=0;j<property.length;j++){delete c[property[j]]}
        return c})};Seule.fn.in=function(json,query,values,orderBy){var column=query.split(" "),data1=JSON.stringify(values),result,obj=[];for(var j=0;j<json.length;j++){obj[j]=json[j]}
        var i=obj.length;while(i--){if(column[2].toLowerCase()=='like'){if(data1.toString().toLowerCase().indexOf(obj[i][column[1]].toString().toLowerCase())==-1){obj.splice(i,1)}}
            if(column[2].toLowerCase()=='not'){if(data1.toString().toLowerCase().indexOf(obj[i][column[1]].toString().toLowerCase())!=-1){obj.splice(i,1)}}}
        if(orderBy!=null){var order=orderBy.split(" ");result=obj.sort(sortByProperty(order[2]))}else{result=obj}
        return this&&result};Seule.fn.search=function(value,query,json){var item;return json.filter(function(x){for(var i in x){item=x[i].toString().toLowerCase();if(query.toLowerCase()=='in'){if(item.indexOf(value.toString().toLowerCase())>-1)return x}
    else{return'the server detected a syntax error in your request. check your request and all parameters'}}})};Seule.fn.delete=function(from,object,query,val,orderBy){var objitem=this.select('* From',object,query,val,orderBy),param=query.split(" ");objitem.forEach(function(f){return object.splice(object.findIndex(function(e){return e[param[1]]===f[param[1]]}),1)});return object};Seule.fn.insert=function(into,json,value,element){json.push(element);return json};Seule.fn.update=function(json,set,value,query,val,orderBy){var objitem=this.select('* From',json,query,val,orderBy),param=set.split(" "),item=query.split(" ");objitem.forEach(function(f){return json.findIndex(function(e){if(e===f){e[param[1]]=value}})});return json};Seule.fn.alter=function(json,query,columns){return json.map(function(o){var c=o;if(columns==null){var item=query.split(" ");c[item[4]]=c[item[2]];delete c[item[2]]}
        if(query.toLowerCase()==='drop'){for(var x=0;x<columns.length;x++){delete c[columns[x]]}}
        if(query.toLowerCase()==='add'){for(var k=0;k<columns.length;k++){if(c.hasOwnProperty(columns[k])){}
        else{c[columns[k]]=""}}}
        return c})};Seule.fn.parent=function(){return new Seule(this[0].parentElement)};Seule.fn.child=function(index){if(index!=null){return new Seule(this[0].children[index])}
        return new Seule(this[0].querySelectorAll(":scope > *"))};Seule.fn.find=function(element){return new Seule(this.parrent+' '+element)};Seule.fn.first=function(){return Seule(this[0])};Seule.fn.last=function(){return Seule(this[this.length])};Seule.fn.filter=function(attribute){var result=[];var newArray=Array.from(this[0].children).filter(function(item){result.push(item.hasAttribute(attribute))});for(var i=0;i<result.length;i++){if(result[i]==!1){this[0].children[i].style.display="none"}}
        return this};Seule.fn.decrypt=function(secret,data){let decrypted=CryptoJS.AES.decrypt(data,secret);return decrypted.toString(CryptoJS.enc.Utf8)};Seule.fn.encrypt=function(secret,data){let encrypted=CryptoJS.AES.encrypt(data,secret);return encrypted.toString()};Seule.fn.mSelect=function(selector){return document.querySelectorAll(this.parrent+" "+selector)};Seule.fn.iniT=function(attrib){var boite=this.mSelect(" ["+attrib+"]"),resultType=[],resultEvent=[];for(var i=0;i<boite.length;i++){var valeur=boite[i].getAttribute(attrib);var option=valeur.split("{");var event=option[0];var type=option[1].slice(0,-1);resultType.push(type);resultEvent.push(event)}
        return{element:boite,type:resultType,event:resultEvent}};Seule.fn.callFunction=function(element,event,callback){if(event===""){callback()}
        element.addEventListener(event,function(){callback()})};Seule.fn.attribute=function(attrib,css){var _this=this;var type=this.iniT(attrib).type,element=this.iniT(attrib).element,event=this.iniT(attrib).event;var _loop=function _loop(i){_this.callFunction(element[i],event[i],function(){element[i].style[css]=type[i];element[i].removeAttribute(attrib)})};for(var i=0;i<type.length;i++){_loop(i)}};Seule.fn.changeMe=function(attrib,value){var _this2=this;var type=this.iniT(attrib).type,element=this.iniT(attrib).element,event=this.iniT(attrib).event;var _loop2=function _loop2(i){_this2.callFunction(element[i],event[i],function(){element[i][value]=type[i];element[i].removeAttribute(attrib)})};for(var i=0;i<type.length;i++){_loop2(i)}};Seule.fn.goTo=function(attrib){var _this3=this;var type=this.iniT(attrib).type,element=this.iniT(attrib).element,event=this.iniT(attrib).event;var _loop3=function _loop3(i){_this3.callFunction(element[i],event[i],function(){if(event[i]===""){element[i].addEventListener("click",function(){window.location=type[i]})}else{window.location=type[i]}})};for(var i=0;i<type.length;i++){_loop3(i)}};Seule.fn.setHtmlMethode=function(attrib,callback){var attribut=this.mSelect(" ["+attrib+"]");var _loop4=function _loop4(i){var valeur=attribut[i].getAttribute(attrib);var option=valeur.split("$");var event=option[0],title=option[1],obj=void 0;attribut[i].style.cursor="pointer";attribut[i].removeAttribute(attrib);var newStr=title.replace(/[~`]/g,'"');if(newStr.includes("{")===!0){obj=JSON.parse(newStr)}else{obj=newStr}
        if(event===""){callback(obj)}
        attribut[i].addEventListener(event,function(){callback(obj)})};for(var i=0;i<attribut.length;i++){_loop4(i)}};Seule.fn.includeHTML=function(attrib){var _this4=this;var type=this.iniT(attrib).type,element=this.iniT(attrib).element,event=this.iniT(attrib).event,getMethod=this.get;var _loop5=function _loop5(i){_this4.callFunction(element[i],event[i],function(){getMethod(type).then(function(data){element[i].innerHTML=data;element[i].removeAttribute(attrib)})})};for(var i=0;i<type.length;i++){_loop5(i)}};Seule.fn.alert=function(attrib){var _this5=this;var type=this.iniT(attrib).type,element=this.iniT(attrib).element,event=this.iniT(attrib).event;var _loop6=function _loop6(i){_this5.callFunction(element[i],event[i],function(){alert(type[i]);element[i].removeAttribute(attrib)})};for(var i=0;i<type.length;i++){_loop6(i)}};Seule.fn.animation=function(attrib){var _this6=this;var type=this.iniT(attrib).type,element=this.iniT(attrib).element,event=this.iniT(attrib).event;var _loop7=function _loop7(i){_this6.callFunction(element[i],event[i],function(){window.animer[type[i]](element[i]);element[i].removeAttribute(attrib)})};for(var i=0;i<type.length;i++){_loop7(i)}};Seule.fn.htmlSetting=function(){this.attribute("s-color","color");this.attribute("s-fontFamily","fontFamily");this.attribute("s-fontSize","fontSize");this.attribute("s-fontStyle","fontStyle");this.attribute("s-textDecoration","textDecoration");this.attribute("s-textDecorationColor","textDecorationColor");this.attribute("s-textDecorationLine","textDecorationLine");this.attribute("s-textDecorationStyle","textDecorationStyle");this.attribute("s-textAlign","textAlign");this.attribute("s-background","background");this.attribute("s-backgroundColor","backgroundColor");this.attribute("s-backgroundImage","backgroundImage");this.attribute("s-backgroundPosition","backgroundPosition");this.attribute("s-backgroundRepeat","backgroundRepeat");this.attribute("s-backgroundSize","backgroundSize");this.attribute("s-border","border");this.attribute("s-borderBottom","borderBottom");this.attribute("s-borderTop","borderTop");this.attribute("s-borderLeft","borderLeft");this.attribute("s-borderRight","borderRight");this.attribute("s-float","float");this.attribute("s-position","position");this.attribute("s-zIndex","zIndex");this.attribute("s-display","display");this.attribute("s-opacity","opacity");this.attribute("s-visibility","visibility");this.attribute("s-padding","padding");this.attribute("s-margin","margin");this.attribute("s-width","width");this.attribute("s-height","height");this.attribute("s-transition","transition");this.changeMe("s-text","innerText");this.changeMe("s-title","title");this.changeMe("s-val","value");this.changeMe("s-type","type");this.changeMe("s-placeholder","placeholder");this.changeMe("s-name","name");this.changeMe("s-id","id");this.changeMe("s-class","class");this.changeMe("s-selected","selected");this.changeMe("s-size","size");this.changeMe("s-multiple","multiple");this.changeMe("s-rows","rows");this.changeMe("s-cols","cols");this.changeMe("s-alt","alt");this.changeMe("s-source","src");this.changeMe("s-href","href");this.changeMe("s-target","target");this.changeMe("s-disabled","disabled");this.changeMe("s-maxlength","maxlength");this.changeMe("s-autocomplete","autocomplete");this.changeMe("s-novalidate","novalidate");this.changeMe("s-form","form");this.changeMe("s-readonly","readonly");this.goTo("s-link");this.includeHTML("s-load");this.alert("s-alert");this.animation("s-anime");return this.length};Seule.fn.addClass=function(classes){return this.each(function(){this.className+=" "+classes})};Seule.fn.removeClass=function(className){return this.each(function(){this.className=this.className.replace(new RegExp("\\b"+className+"\\b","g"),"")})};Seule.fn.toggleClass=function(className){return this.each(function(){this.classList.toggle(className)})};Seule.fn.class=function(className,action){return this.each(function(){if(action==="remove"){this.classList.remove(className)}else if(action==="toggle"){this.classList.toggle(className)}else{this.classList.add(className)}})};Seule.fn.style=function(cssProperty,value){return this.each(function(){this.style[cssProperty]=value})};Seule.fn.css=function(obj){var query=this.objectToStyle(obj);return this.each(function(){this.setAttribute("style",query)})};Seule.fn.getStyle=function(cssProperty){var style=getComputedStyle(this[0]);return this.length&&style[cssProperty]};Seule.fn.classList=function(){var result=[];for(var j=0;j<this[0].classList.length;j++){result.push(this[0].classList.item(j))}
        return this.length&&result};Seule.fn.classListContains=function(className){return this.length&&this[0].classList.contains(className)};Seule.fn.anime=function(animation,options){return this&&window.animer[animation](this.parrent,options)};Seule.fn.show=function(){return this.each(function(){var style=getComputedStyle(this);if(style.display=="none"){this.style.display="inherit"}else{this.style.display=style.display}})};Seule.fn.hide=function(){return this.each(function(){this.style.display="none"})};Seule.fn.visible=function(isTrue){return this.each(function(){if(isTrue==!1){this.style.visibility="hidden"}else{this.style.visibility="visible"}})};Seule.fn.isVisible=function(){var result=!0;if(this[0].style.visibility==="hidden"){result=!1}
        return this.length&&result};Seule.fn.opacity=function(value){return this.each(function(){this.style.opacity=value})};Seule.fn.text=function(str){if(str!=null){return this.each(function(){this["innerText"]=str})}
        return this.length&&this[0].innerText};Seule.fn.val=function(value){if(value!=null){return this.each(function(){this.value=value})}
        return this.length&&this[0].value};Seule.fn.attr=function(attribute,value){if(value!=null){return this.each(function(){this.setAttribute(attribute,value)})}
        return this.length&&this[0].getAttribute(attribute)};Seule.fn.html=function(html){if(html!=null){return this.each(function(){this.innerHTML=html})}
        return this.length&&this[0].innerHTML};Seule.fn.attr=function(attribute,value){if(attribute){return this.each(function(){this.setAttribute(attribute,value)})}
        return this.length&&this[0].getAttribute(attribute)};Seule.fn.append=function(html,position){var pos=hTmlplace("beforeend",position);return this.each(function(){this.insertAdjacentHTML(pos,html)})};Seule.fn.insertHtml=function(html,position){var pos=hTmlplace("afterend",position);return this.each(function(){this.insertAdjacentHTML(pos,html)})};Seule.fn.template=function(obj){return this.get(obj.html).then(function(done){var htmlData='<template id="'+obj.tag+'"><link rel="stylesheet" href="'+obj.css+'">'+done+'</template>';document.body.insertAdjacentHTML('beforeend',htmlData);customElements.define(obj.tag,class extends HTMLElement{constructor(){super();const template=document.getElementById(obj.tag).content;const shadowRoot=this.attachShadow({mode:'open'}).appendChild(template.cloneNode(!0))}})})};Seule.fn.on=function(name,handler){return this.each(function(){this.addEventListener(name,handler,!1)})};Seule.fn.click=function(handler){return this.each(function(){this.addEventListener("click",handler,!1)})};Seule.fn.dblClick=function(handler){return this.each(function(){this.addEventListener("dblclick",handler,!1)})};Seule.fn.focus=function(handler){return this.each(function(){if(handler==null){this.focus();return!1}
        this.addEventListener("focus",handler,!1)})};Seule.fn.blur=function(handler){return this.each(function(){if(handler==null){this.blur();return!1}
        this.addEventListener("blur",handler,!1)})};Seule.fn.switch=function(obj){return this.each(function(){this.addEventListener(obj.event,function(){if(this.check===!0){obj.callback();this.check=!1}else{obj.handler();this.check=!0}},!1)})};Seule.fn.emit=function(obj){var target=document.querySelector(obj.target);return this.each(function(){this.addEventListener(obj.event,function(){var eventFired=new MouseEvent(obj.emit,{view:window,bubbles:!0,cancelable:!0});target.dispatchEvent(eventFired)},!1)})};Seule.fn.holdOn=function(handler){return this.each(function(){this.addEventListener("long-press",handler,!1)})};Seule.fn.swipeOn=function(event,callback){var el=this;el[0].addEventListener("touchstart",handleTouchStart,!1);el[0].addEventListener("touchmove",handleTouchMove,!1);var xDown=null;var yDown=null;function handleTouchStart(evt){xDown=evt.touches[0].clientX;yDown=evt.touches[0].clientY}
        ...
        function B(a,b){var g,c,d,f=[];g=a;"+"===g?g=["+"]:(g=g.replace(/\+{2}/g,"+plus"),g=g.split("+"));for(d=0;d<g.length;++d)c=g[d],C[c]&&(c=C[c]),b&&"keypress"!=b&&D[c]&&(c=D[c],f.push("shift")),x(c)&&f.push(c);g=c;d=b;if(!d){if(!n){n={};for(var q in p)95<q&&112>q||p.hasOwnProperty(q)&&(n[p[q]]=q)}
        ...
        function c(a){function b(a){a=a||{};var b=!1,l;for(l in n)a[l]?b=!0:n[l]=0;b||(y=!1)}
            function g(a,b,u,e,c,g){var l,m,k=[],f=u.type;if(!h._callbacks[a])return[];"keyup"==f&&x(a)&&(b=[a]);for(l=0;l<h._callbacks[a].length;++l)
                if(m=h._callbacks[a][l],(e||!m.seq||n[m.seq]==m.level)&&f==m.action){var d;(d="keypress"==f&&!u.metaKey&&!u.ctrlKey)||(d=m.modifiers,d=b.sort().join(",")===d.sort().join(","));d&&(d=e&&m.seq==e&&m.level==g,(!e&&m.combo==c||d)&&h._callbacks[a].splice(l,1),k.push(m))}
                return k}
