(function(window,undefined){var domReadyStack=[];function handleDOMReady(fn){return document.readyState==='complete'?fn.call(document):domReadyStack.push(fn)}
    ...
    else if(param[2].toLowerCase()=="like"||param[2]=="="){this.promes=object.filter(function(d){item=d[colName].toString().toLowerCase();return item==val.toString().toLowerCase()})}
